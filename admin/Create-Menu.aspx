<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Create-Menu.aspx.cs" Inherits="admin_Create_Menu" %>
        ...
        <div class="body">
            ...
            <asp:Button ID="btnHide" runat="server" Text="Close" />
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <input class="form-control col-md-8" id="validationCustom0" runat="server" type="text" required="">
                                    </div>

                                      <div class="form-group row">
                                                    <label for="exampleFormControlSelect1" class="col-xl-3 col-sm-4 mb-0">Visibility :</label>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="checkbox checkbox-primary col-xl-9 col-md-8">
                                            <asp:CheckBox ID="CheckBox1" Text="Enable the Menu" runat="server" />
                                           
                                        </div>
                                    </div>
                                    <asp:Button ID="Button1" class="btn btn-primary d-block" runat="server" OnClick="Button1_Click" Text="Save" />
