<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Category.aspx.cs" Inherits="back_end_Category" %>
<!DOCTYPE html>
<html lang="en">
<head>
            ...
            <div class="container-fluid">
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Category Name">
                        <ItemTemplate>
                            <asp:Label ID="lblFullName" runat="server" Text='<%#Eval("Cat_Name") %>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                    ...
                    <asp:TemplateField HeaderText="Category Image">
                        <ItemTemplate>
                            <asp:Image ID="imgProfilePicture" runat="server" ImageUrl='<%#  "data:image/jpg;base64," + Convert.ToBase64String((byte[])Eval("Data"))%>' Style="height: 50px; width: 50px"></asp:Image>
                        </ItemTemplate>
                    </asp:TemplateField>
